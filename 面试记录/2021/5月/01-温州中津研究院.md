...
#### 2.header、nav、section、aside、article、footer这些标签有什么含义？
...
#### 1.JS中有那些基本数据类型？有那些引用数据类型？它们之间的区别是？
...
#### 2.map、filter、find、findIndex的使用场景是哪些？
...
#### 3.综合题：promise+setTimeout()+函数，判断输出。
